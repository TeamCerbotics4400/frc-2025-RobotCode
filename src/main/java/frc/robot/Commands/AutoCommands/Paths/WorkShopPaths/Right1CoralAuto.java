...
public class Right1CoralAuto extends AutoCommand {

  private final PathPlannerPath first;
  private final PathPlannerPath second;

  public Right1CoralAuto() {
    first = loadPath("1RightCoral1");
    second = loadPath("1RightCoral2");

    addCommands(
        Commands.deadline(
            Commands.sequence(
             new PathPlannerAuto("1RightCoralAuto"))));
  }
