...
public class Left4CoralAuto extends AutoCommand {
  ...
  public Left4CoralAuto() {
    first = loadPath("4LeftCoral1");
    second = loadPath("4LeftCoral2");
    third = loadPath("4LeftCoral3");
    fourth = loadPath("4LeftCoral4");
    five = loadPath("4LeftCoral5");
    six = loadPath("4LeftCoral6");
    seven = loadPath("4LeftCoral7");

    addCommands(
        Commands.deadline(
            Commands.sequence(
             new PathPlannerAuto("4LeftCoralAuto"))));
  }
